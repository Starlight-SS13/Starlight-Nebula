...
/mob/living/fire_act(datum/gas_mixture/air, exposed_temperature, exposed_volume)
	//once our fire_burn_temperature has reached the temperature of the fire that's giving fire_intensity, stop adding them.
	//allow fire_intensity to go up to 4 for fires cooler than 700 K, since are being immersed in flame after all.
