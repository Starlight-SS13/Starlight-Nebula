...
var/global/lightmode_style = url_encode(file2text('code/game/client/lightmode.css'))
var/global/darkmode_style = url_encode(file2text('code/game/client/darkmode.css'))
...
/proc/ReloadThemeCss(client/C, quiet = FALSE)
	...
	global.lightmode_style = url_encode(file2text('code/game/client/lightmode.css'))
	global.darkmode_style  = url_encode(file2text('code/game/client/darkmode.css'))
